      ...
      <Container className="mt-16">
        <GridList>
          ...
          <GridListItem title="Тасралтгүй суралцахуй" invert>
            Сургалтын Академийн хүрээнд жил бүр 1000 гаруй мэргэжлийн үсчинд
    ...
    <>
      <PageIntro eyebrow="Бидний тухай" title="2013 оноос хойших итгэлцэл">
        ...
        <div className="mt-10 max-w-2xl space-y-6 text-base">
          ...
          <p>
            ...
            танигдсан. Жил бүр 1000 гаруй мэргэжлийн үсчинд сургалт явуулж,
      ...
      <Container className="mt-16">
        <StatList>
          ...
          <StatListItem value="4.5 тэрбум₮" label="2026 оны борлуулалт" />
        </StatList>
      </Container>
